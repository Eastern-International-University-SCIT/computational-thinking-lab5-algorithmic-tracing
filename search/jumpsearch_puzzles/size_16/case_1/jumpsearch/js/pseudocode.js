...
window.PseudocodeView = (function () {
  ...
  const STEP_IDS = {
    ...
    setStep: "setStep",
    setPrev: "setPrev",
    setStepOrN: "setStepOrN",
    whileJump: "whileJump",
    updatePrev: "updatePrev",
    updateStep: "updateStep",
    checkPrevGeN: "checkPrevGeN",
    returnMissJump: "returnMissJump",
    updateStepOrN: "updateStepOrN",
    whileLinear: "whileLinear",
    incPrev: "incPrev",
    checkBound: "checkBound",
    returnMissLinear: "returnMissLinear",
...
window.JS_STEP_IDS = window.PseudocodeView.STEP_IDS;

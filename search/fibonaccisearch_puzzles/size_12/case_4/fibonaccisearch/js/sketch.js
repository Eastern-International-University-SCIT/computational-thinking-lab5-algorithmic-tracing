/**
 * p5.js WEBGL visualization for Fibonacci Search.
 * Sorted array as square 3D boxes; offset / i / last pointers; search-range highlight.
 */
...
window.ArrayViz = (function () {
  ...
  const state = {
    ...
    missIndex: -1,
    range: { low: -1, high: -1 },
    pointers: { low: null, mid: null, high: null },
    compare: null,
    compareAnim: null,
    keyValue: null,
    keyDisplayX: 0,
  ...
  function setArray(values) {
    ...
    state.missIndex = -1;
    state.highlight = -1;
    state.pointers = { low: null, mid: null, high: null };

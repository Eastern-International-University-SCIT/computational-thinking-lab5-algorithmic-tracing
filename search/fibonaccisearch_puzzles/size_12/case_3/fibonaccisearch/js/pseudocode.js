...
window.PseudocodeView = (function () {
  ...
  const STEP_IDS = {
    mainCall: "mainCall",
    setFibMMm2: "setFibMMm2",
    setFibMMm1: "setFibMMm1",
    setFibM: "setFibM",
    whileFibGrow: "whileFibGrow",
    growFibMMm2: "growFibMMm2",
    growFibMMm1: "growFibMMm1",
    growFibM: "growFibM",
    setOffset: "setOffset",
    whileFibM: "whileFibM",
    setI: "setI",
    checkLess: "checkLess",
    shrinkRightFibM: "shrinkRightFibM",
    shrinkRightFibMMm1: "shrinkRightFibMMm1",
    shrinkRightFibMMm2: "shrinkRightFibMMm2",
    updateOffset: "updateOffset",
    checkGreater: "checkGreater",
    shrinkLeftFibM: "shrinkLeftFibM",
    shrinkLeftFibMMm1: "shrinkLeftFibMMm1",
    shrinkLeftFibMMm2: "shrinkLeftFibMMm2",
...
window.FS_STEP_IDS = window.PseudocodeView.STEP_IDS;

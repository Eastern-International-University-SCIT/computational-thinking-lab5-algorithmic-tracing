...
window.PseudocodeView = (function () {
  ...
  const STEP_IDS = {
    ...
    forJ: "forJ",
    compare: "compare",
    swapAdjacent: "swapAdjacent",
    setSwappedTrue: "setSwappedTrue",
    markSortedEnd: "markSortedEnd",
    checkEarlyExit: "checkEarlyExit",
...
window.BS_STEP_IDS = window.PseudocodeView.STEP_IDS;

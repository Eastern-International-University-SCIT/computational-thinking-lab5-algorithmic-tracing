...
window.PseudocodeView = (function () {
  /** Stable step ids used by the executor (same keys as former Blockly ids). */
  const STEP_IDS = {
    markRange: "markRange",
    checkLowHigh: "checkLowHigh",
    callPartition: "callPartition",
    sortLeft: "sortLeft",
    sortRight: "sortRight",
    setPivot: "setPivot",
    initI: "initI",
...
// Keep legacy name used by executor mapping
window.QS_STEP_IDS = window.PseudocodeView.STEP_IDS;

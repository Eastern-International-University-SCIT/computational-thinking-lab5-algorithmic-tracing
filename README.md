...
The course contains 120 execution-trace puzzles in this required order:
...
The reusable integrity checker is `tools/audit-puzzles.js`. It validates the 120 puzzle instances, 12,778 trace rows, 14,587 answer pieces, available CSV traces, embedded game data, step references, and final algorithm outcomes.
